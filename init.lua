...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      delay = 700, -- DLA: Add delay to open popup after press key
      icons = {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    event = 'VimEnter',
    --branch = '0.1.x', -- DLA: always pull latest branch
    dependencies = {
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          ...
          path_display = {
            filename_first = {
              reverse_directories = false, -- keep the original order
            },
          },
          mappings = {
            i = {
      ...
      --vim.keymap.set('n', '<C-f>', '<cmd>lua FuzzyFindFiles{}<cr>', { desc = '[S]earch by [G]rep' })
